...
public class DeviceMethodTests extends DeviceMethodCommon
{
    ...
    public void invokeMethodInvokeParallelSucceed() throws Exception
    {
        ...
        for (int i = 0; i < NUMBER_INVOKES_PARALLEL; i++)
        {
            ...
            DeviceMethod methodServiceClient = DeviceMethod.createFromConnectionString(iotHubConnectionString, DeviceMethodClientOptions.builder().httpReadTimeout(0).build());
    ...
    public void invokeMethodWithServiceSideProxy() throws Exception
    {
        ...
        try
        {
            ...
            DeviceMethodClientOptions options = DeviceMethodClientOptions.builder().proxyOptions(proxyOptions).httpReadTimeout(0).build();
